              ...
              return (
                <div key={step.key} className="flex items-center gap-4">
                  <div className={`
                    ...
                    ${isCurrent ? 'bg-orange-100 text-orange-600 ring-4 ring-orange-50 animate-pulse-slow' : ''}
                  ...
                  <div className="flex-1">
                    ...
                    {isDelivered && step.key === 'DELIVERED' && (
